...
public final class ArchiveCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            sender.sendMessage(ChatColor.GRAY + "Usage: /riftarchive logging <on|off|toggle> or /riftarchive reload");
            return true;
        }
        ...
        switch (args[0].toLowerCase()) {
            ...
            default -> sender.sendMessage(ChatColor.YELLOW + "Usage: /riftarchive logging <on|off|toggle> or /riftarchive reload");
        }
        return true;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) {
            return partial(args[0], List.of("logging", "reload"));
        }
